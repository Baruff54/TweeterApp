...
class RouterTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertTrue(
            is_subclass_of('Tweeter\mf\router\Router', 'Tweeter\mf\router\AbstractRouter'),
    ...
    public function testAddRoute()
    {
        ...
        $routes = $this->getPrivateProperty('Tweeter\mf\router\Router', 'routes')->getValue($r);
        $aliases = $this->getPrivateProperty('Tweeter\mf\router\Router', 'aliases')->getValue($r);
