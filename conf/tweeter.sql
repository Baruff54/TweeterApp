...
--
-- Hôte : localhost:3306
-- Généré le : ven. 14 oct. 2022 à 23:30
...
(49, 'Off to Waterloo. Wish me luck.', 8, 0, '2022-10-06 09:41:48', '0000-00-00 00:00:00'),
...
(75, 'Nulla mollit ullamco exercitation cillum culpa eu cupidatat tempor minim esse laboris mollit deserunt voluptate.', 3, 0, '2022-10-14 20:25:02', '2022-10-14 20:25:02');
...
CREATE TABLE `user` (
  ...
  `password` varchar(512) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
(12, 'Test test2', 'testeur', '123', 58, 86),
(13, '', '', NULL, NULL, NULL),
(14, 'pomme', 'poire', NULL, NULL, NULL),
(15, 'test', 'tester', 'secure', NULL, NULL);
